  ...
  theme: {
    extend: {
      ...
      transitionTimingFunction: {
        ...
        "md3-standard-decelerate":
          "var(--md-sys-motion-easing-standard-decelerate)",
        "md3-standard-accelerate":
      ...
      animation: {
        "md3-fade-in":
          "md3-fade-in var(--md-sys-motion-duration-medium2) var(--md-sys-motion-easing-emphasized-decelerate)",
        "md3-fade-out":
          "md3-fade-out var(--md-sys-motion-duration-short4) var(--md-sys-motion-easing-emphasized-accelerate)",
        "md3-scale-in":
          "md3-scale-in var(--md-sys-motion-duration-medium2) var(--md-sys-motion-easing-emphasized-decelerate)",
        "md3-scale-out":
          "md3-scale-out var(--md-sys-motion-duration-short4) var(--md-sys-motion-easing-emphasized-accelerate)",
        "md3-slide-in-right":
          "md3-slide-in-right var(--md-sys-motion-duration-medium4) var(--md-sys-motion-easing-emphasized-decelerate)",
        "md3-slide-out-right":
          "md3-slide-out-right var(--md-sys-motion-duration-short4) var(--md-sys-motion-easing-emphasized-accelerate)",
        "md3-slide-in-bottom":
          "md3-slide-in-bottom var(--md-sys-motion-duration-medium4) var(--md-sys-motion-easing-emphasized-decelerate)",
        "md3-slide-out-bottom":
          "md3-slide-out-bottom var(--md-sys-motion-duration-short4) var(--md-sys-motion-easing-emphasized-accelerate)",
      },
    },
  },
