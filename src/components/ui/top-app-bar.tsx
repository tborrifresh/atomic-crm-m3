      ...
      >
        <div
          className={cn(
            ...
            variant === "medium"
              ? "h-28 flex-col items-start justify-end pb-4"
              : variant === "large"
                ? "h-36 flex-col items-start justify-end pb-6"
                : "h-16"
          )}
        >
          ...
          {(variant === "medium" || variant === "large") && (
            <div className="flex w-full items-center justify-between mb-auto pt-4">
              <div className="flex items-center gap-4">{navigationIcon}</div>
              <div className="flex items-center gap-4">{actionIcons}</div>
            </div>
          )}
              ...
              <div className="flex items-center gap-4">
                ...
                <h1
                  className={cn(
                    "font-medium",
                    variant === "center"
                      ? "absolute left-1/2 -translate-x-1/2 text-title-large"
                      : "text-title-large"
                  )}
                >
                  {title}
